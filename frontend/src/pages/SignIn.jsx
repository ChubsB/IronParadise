  ...
  return (
    <main className="lg:max-w-xl lg:p-0 lg:space-y-14 p-6 w-full bg-white space-y-6">
      ...
      <form className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div
            ...
            className="flex justify-end text-sm text-star cursor-pointer"
          >
            Forgot password?
          </div>
        </div>
        {message && <div className="text-star font-semibold">{message}</div>}
      ...
      <Button
        ...
        fullWidth
      />
      <div className="text-star text-center">
