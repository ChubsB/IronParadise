    ...
    <div className="space-y-10 w-full">
      ...
      <main className="lg:flex lg:space-x-10 space-y-5 lg:space-y-0">
        ...
        <section className="flex-grow bg-white rounded-xl lg:flex">
          <div className="p-10 space-y-10">
            <h2 className="text-lg text-star">Calories</h2>
            <div className="space-y-1">
              <h5 className="font-light text-sm text-star">TODAY</h5>
              <h3 className="font-light text-6xl text-star">
                {isFetchingWorkouts ? 0 : parseInt(calories.today)}
              </h3>
            </div>
            <div className="space-y-1">
              <h5 className="font-light text-sm text-star">THIS WEEK</h5>
              <h3 className="font-light text-6xl text-star">
                {isFetchingWorkouts ? 0 : parseInt(calories.week)}
              </h3>
            </div>
            <div className="space-y-1">
              <h5 className="font-light text-sm text-star">THIS MONTH</h5>
              <h3 className="font-light text-6xl text-star">
